...
<div class="form_head">Delete Subject</div>
...
<table style=" margin:auto" width="335" border="1" >
  <tr>
    ...
    <td width="63" align="center"><strong>Name</strong></td>
     <td width="57" align="center"><strong>Delete</strong></td>
  </tr>
  <?php 
  $i=1;
  ...
  <tr>
    ...
    <td><a href="subject_delete.php?id=<?php echo $row[0];?>&amp;name=<?php echo $row[1];?>">Delete</a>
	</td>
  </tr>
   <?php  
   } 
