...
<div id="body">
  ...
  <div id="content">
      <div id="main_login">
        <div class="form_head">Add Contents</div>
...
function getSubcat(subjectId) { 
 ...
 if(window.XMLHttpRequest)
 {
  ...
  xmlhttp.onreadystatechange=function(){
   ...
   xmlhttp.open("GET","addOnlyContent.php?subject="+subjectId+"&subcat="+sub_subject, true);
 ...
 <?php } ?>
          ...
          <div class="form_main_line">
           <div class="form_main_line_left">Subcategory</div>
            <div class="form_main_line_right">
              <div id="subsubject">
              <select><option>--select subcategory--</option></select>
              </div>
            </div>
          </div>
          <br />
  ...
  <?php 
    ...
    {  
	 ...
	 $query="insert into tbl_content values(null,'$subject','$subcat','$heading','$desc','$content','$example','$path','$video','$path1')";
	 	 
 $result=mysql_query($query);
 
echo "<br><center><mark>Data Inserted</mark></center>";
