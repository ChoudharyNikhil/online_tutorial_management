...
if($_SESSION["session"]==1)
{
	...
	if(isset($_POST['btn_edit_sub']))
	{
  		...
  		if($sub_name==''||$sub_name==null )
 		{
  			...
  			$new_name=$sub_name;
  			$sql="update tbl_subtopic set topic_name='$new_name' where id=$topic_id";
  			$rs=mysql_query($sql);
 			header("location:sub_topic_edit.php");
...
<div id="body"> 
 ...
 <div id="main_login">
 <div class="form_head">Edit Topic</div>
<script>
...
<div class="form_main_line_left">Topic Name</div>
<div class="form_main_line_right">
<input class="text" type="text" id="edit_sub" name="edit_sub" value="<?php echo $old_name;?>"onblur="return  blank_val(this.id)" /></div>
</div>
